...
class Sales_model extends CI_Model
{
  ...
  //           ->group_by('deliveries.id')
    ...
    {
		$this->db->select('id, date, reference_no, biller, customer, sale_status, sales.grand_total, sales.paid, (erp_sales.grand_total - erp_sales.paid) as balance, payment_status');
		$this->db->from('sales');
