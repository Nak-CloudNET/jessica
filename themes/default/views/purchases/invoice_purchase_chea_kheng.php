		...
		<div class="col-lg-12" >
			<div class="col-lg-6 col-sm-6 col-xs-6" style="padding: 10px;">
				<table style="line-height:35px;">
					<tr>
						<td style="font-size:19px !important;"><b><?=lang('Reference')?></b></td>
					</tr>
					<tr>
						<td><?=lang('from')?></td>
						<td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>
			...
			<div class="col-lg-6 col-sm-6 col-xs-6" style="padding: 10px;">
				<table style="line-height:35px;">
					<tr>
						<td style="font-size:19px !important;"><b><?=lang('Supplier')?></b></td>
					</tr>
					<tr>
						<td style="font-size:17px !important;"><?=lang('To')?></td>
					...
					<tr>
						<td style="font-size:17px !important;"><?=lang('Address')?></td>
						<td style="font-size:17px !important;">&nbsp;&nbsp;:&nbsp;&nbsp;</td>
					...
					<tr>
						<td style="font-size:17px !important;"><?=lang('Contact')?></td>
						<td style="font-size:17px !important;">&nbsp;&nbsp;:&nbsp;&nbsp;</td>
